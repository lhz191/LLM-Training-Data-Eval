...
FEAT_CONV = join(BASE_DIR, '../baseline_models/data/feat_conv.pt')
FEAT_IDS = join(BASE_DIR, '../baseline_models/data/feat_ids.pt')

HUMAN_ATTR_PATH = join(BASE_DIR, '../baseline_models/data/items_human_ins.json')
