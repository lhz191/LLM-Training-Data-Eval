...
python3 -u run_full_test.py --metric diversity --dataset openmathinstruct --diversity-method vendi --embedding-model Qwen/Qwen3-Embedding-8B --embedding-batch-size 4 --vendi-batch-size 6500 --num-gpus 8
echo ""
