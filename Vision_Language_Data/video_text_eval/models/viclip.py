...
class ViCLIP(nn.Module):
    ...
    def __init__(self,  tokenizer=None, pretrain=os.path.join("/mnt/petrelfs/wangjiedong/.cache/huggingface/hub/models--OpenGVLab--ViCLIP/snapshots/67fbc34595ae6e5f56ab630fe421d3fc45c8670d/", "ViClip-InternVid-10M-FLT.pth"), freeze_text=True):
