...
class ExecutabilityChecker(BaseExecutabilityChecker):
    """
    可执行性检查器基类（API Agent - 静态检查）
...
class DynamicChecker(BaseDynamicChecker):
    """
    动态可执行性检查器基类（API Agent）
