...
python3 -u scripts/run_full_test.py --metric diversity --dataset toolbench --diversity-method vendi --embedding-model Qwen/Qwen3-Embedding-8B --embedding-batch-size 4 --vendi-batch-size 6500 --num-gpus 8
