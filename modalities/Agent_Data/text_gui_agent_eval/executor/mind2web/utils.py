...
包含：
- CSS 相关：is_dynamic_class, escape_css_value
- 数据解析：parse_candidate
- 元素定位：find_element_by_all_attributes
- 元素验证：verify_by_coords, verify_by_attrs, verify_element_match
"""
...
def verify_by_coords(page, target_element) -> Tuple[bool, str, Any]:
    ...
    if not target_element:
        print(f"    ❌ 无 target_element（数据集缺失）")
